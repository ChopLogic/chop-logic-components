...
}`},(O=(K=f.parameters)==null?void 0:K.docs)==null?void 0:O.source)})});var W,Y,J;g.parameters=m(p({},g.parameters),{docs:m(p({},(W=g.parameters)==null?void 0:W.docs),{source:p({originalSource:`{
  args: {
    selectable: true,
...
}`},(J=(Y=g.parameters)==null?void 0:Y.docs)==null?void 0:J.source)})});const ke=["DefaultGrid","SelectableGrid"],Ee=Object.freeze(Object.defineProperty({__proto__:null,DefaultGrid:f,SelectableGrid:g,__namedExportsOrder:ke,default:Se},Symbol.toStringTag,{value:"Module"}));export{Ee as G};
