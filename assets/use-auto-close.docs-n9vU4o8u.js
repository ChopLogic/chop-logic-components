...
`,e.jsxs(n.p,{children:["For auto-closing functionality with a countdown timer that can be paused and resumed (e.g., when hovering), consider using the ",e.jsx(n.a,{href:"/docs/hooks-useremainingtimer--docs",children:e.jsx(n.code,{children:"useRemainingTimer"})})," hook instead."]})]})}function u(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{u as default};
