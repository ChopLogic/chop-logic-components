...
import { useMDXComponents as s } from './index-DOvxcyG1.js';
import { ae as r, af as i, ag as o } from './index-BZ-G-mNy.js';
import { A as l, D as c } from './Alert.stories-BLc0HVOv.js';
...
`,
      e.jsxs(n.p, {
        children: [
          'The ',
          e.jsx(n.code, { children: 'ChopLogicAlert' }),
          ' component displays an alert message with various modes such as success, error, warning, and info.',
        ],
      }),
      `
`,
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: 'Determines if the alert is open.' }),
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: 'Function that suppose to close the alert and handle additional logic.' }),
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'message' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'boolean' }) }),
                  e.jsx(n.td, { children: 'The message content of the alert.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'Yes' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: 'The title of the alert.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `export type ChopLogicAlertProps = CommonComponentProps & {
  isOpened: boolean;
  onClose: () => void;
  message: string;
