...
import { ae as s, af as r } from './index-BZ-G-mNy.js';
import { D as o, a as l } from './Dialog.stories-CI0TGx0H.js';
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `import { ChopLogicDialog } from 'chop-logic-components';
        ...
        children: [
          ...
          e.jsxs(n.tbody, {
            children: [
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'isOpened' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'boolean' }) }),
                  e.jsx(n.td, { children: 'Determines if the dialog is open.' }),
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'onClose' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: '() => void' }) }),
                  e.jsx(n.td, { children: 'A function that is called when the dialog is closed.' }),
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: 'A string that represents the title of the dialog.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'Yes' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'ReactElement' }) }),
                  e.jsxs(n.td, {
                    children: [
                      'Contents of the dialog window. Any React component enclosed between tags ',
                      e.jsx(n.code, { children: '<ChopLogicDialog>' }),
                      ' and ',
                      e.jsx(n.code, { children: '</ChopLogicDialog>' }),
                      ' will be rendered inside the dialog using ',
                      e.jsx(n.code, { children: 'ReactDOM.createPortal' }),
                      '.',
                    ],
                  }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'mode' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'ChopLogicAlertMode' }) }),
                  e.jsx(n.td, { children: 'The visual mode of the alert.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: "'info'" }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: 'Custom icon that appears in the Alert header.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `export type ChopLogicDialogProps = CommonComponentProps &
