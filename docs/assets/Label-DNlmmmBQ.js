import{r as b}from"./index-qVDZzPEr.js";import{j as n}from"./jsx-runtime-OAISXtky.js";import{d as s,F as p,U as h,C as c}from"./styled-components.browser.esm-BD-stqwa.js";function u(e){const l=b.useId(),r=e??l,a=`${r}_error`,t=`${r}_dropdown`;return{elementId:r,errorId:a,dropdownId:t}}try{u.displayName="useElementIds",u.__docgenInfo={description:"",displayName:"useElementIds",props:{}}}catch{}const d=s.label`
  font-size: 0.8rem;
  font-family: ${p.core};
  display: flex;
  align-items: center;
