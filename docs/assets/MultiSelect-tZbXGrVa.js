...
import { ae as r, af as i } from './index-BZ-G-mNy.js';
import { M as l, D as c } from './MultiSelect.stories-B2MWSGk6.js';
...
function d(t) {
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(r, { of: l, title: 'MultiSelect' }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: 'A styled and accessible multiselect component that can be used both inside a form and as standalone controller.',
      }),
      `
`,
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `import { ChopLogicMultiSelect } from 'chop-logic-components';
        ...
        children: [
          ...
          e.jsxs(n.tbody, {
            children: [
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'options' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'SelectValue[]' }) }),
                  e.jsxs(n.td, {
                    children: [
                      'An array of objects (each object should contain two required fields - ',
                      e.jsx(n.code, { children: 'id: string' }),
                      ' and ',
                      e.jsx(n.code, { children: 'label: string' }),
                      ') representing the options available in the Select dropdown.',
                    ],
                  }),
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: e.jsx(n.code, { children: '(values?: SelectValue[]) => void' }) }),
                  e.jsx(n.td, {
                    children: 'A function that is called when an option is selected. It can be used to handle the selection event.',
                  }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: e.jsx(n.code, { children: "'Not selected'" }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsxs(n.td, {
                    children: [
                      ...
                      ' or ',
                      e.jsx(n.code, { children: 'number' }),
                      ' or ',
                      e.jsx(n.code, { children: 'readonly string[]' }),
                    ],
                  }),
                  e.jsx(n.td, { children: 'The select option object or an id that will be supplied as the default value of the input.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `export type ChopLogicMultiSelectProps = CommonInputProps & {
  options: SelectValue[];
