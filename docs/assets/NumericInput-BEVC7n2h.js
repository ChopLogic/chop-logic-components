import{j as l}from"./jsx-runtime-OAISXtky.js";import{u as O,C as k}from"./Label-DNlmmmBQ.js";import{I as F,C as B}from"./InputInnerButton-BKMibge1.js";import{C as R}from"./Icon-BeaB2qBy.js";import{r as I}from"./index-qVDZzPEr.js";import{C as z,u as U}from"./index-D121fWfN.js";import{d as b,U as n,F as G,C as W,S as P,B as q}from"./styled-components.browser.esm-BD-stqwa.js";function X({name:e,initialValues:r,defaultValue:a}){return r&&r[e]?Number(r[e]):a&&typeof a=="number"?a:0}function J({value:e,required:r,validator:a,maxValue:t,minValue:d}){return r&&!a&&e===void 0?!1:a&&typeof a=="function"?a(e):t&&d&&e&&!a?e<=t&&e>=d:!0}function K({name:e,defaultValue:r,onChange:a,onSpinButtonClick:t,min:d,max:h,step:o,required:x,validator:$}){const{onChangeFormInput:i,initialValues:w}=I.useContext(z),c=X({initialValues:w,defaultValue:r,name:e}),f=h?Number(h):Number.MAX_SAFE_INTEGER,p=d?Number(d):Number.MIN_SAFE_INTEGER,[s,_]=I.useState(c),[S,V]=I.useState(!0),y=u=>{_(u);const m=J({value:u,required:x,validator:$,maxValue:f,minValue:p});V(m),i==null||i({name:e,value:u,valid:m})},N=u=>{const m=Number(u.target.value);y(m),a==null||a(u)},v=()=>{y(s+o),t==null||t(s+o)},T=()=>{y(s-o),t==null||t(s-o)},g=I.useCallback(()=>{_(c),i==null||i({name:e,value:c,valid:!0})},[e]);return U(g),{handleChange:N,value:s,valid:S,minValue:p,maxValue:f,increment:v,decrement:T}}const C=b.div`
  display: flex;
