import{j as i}from"./jsx-runtime-OAISXtky.js";import{d as F,u as R,b as A,I as C,C as L,f as H}from"./index-CreP8U9z.js";import{r as I}from"./index-qVDZzPEr.js";import{C as S,u as k}from"./index-1hWSJLP3.js";import{u as z}from"./index-BHitKVNr.js";function O({name:e,initialValues:r,defaultValue:a}){return r&&r[e]?Number(r[e]):a&&typeof a=="number"?a:0}function B({value:e,required:r,validator:a,maxValue:t,minValue:u}){return r&&!a&&e===void 0?!1:a&&typeof a=="function"?a(e):t&&u&&e&&!a?e<=t&&e>=u:!0}function D({name:e,defaultValue:r,onChange:a,onSpinButtonClick:t,min:u,max:b,step:o,required:N,validator:x}){const{onChangeFormInput:l,initialValues:$}=I.useContext(S),f=O({initialValues:$,defaultValue:r,name:e}),m=b?Number(b):Number.MAX_SAFE_INTEGER,p=u?Number(u):Number.MIN_SAFE_INTEGER,[s,h]=I.useState(f),[q,g]=I.useState(!0),y=n=>{h(n);const c=B({value:n,required:N,validator:x,maxValue:m,minValue:p});g(c),l==null||l({name:e,value:n,valid:c})},v=n=>{const c=Number(n.target.value);y(c),a==null||a(n)},V=()=>{y(s+o),t==null||t(s+o)},d=()=>{y(s-o),t==null||t(s-o)},_=I.useCallback(()=>{h(f),l==null||l({name:e,value:f,valid:!0})},[e]);return z(_),{handleChange:v,value:s,valid:q,minValue:p,maxValue:m,increment:V,decrement:d}}const E=F.div`
  display: flex;
