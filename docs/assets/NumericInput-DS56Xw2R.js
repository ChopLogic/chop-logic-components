...
import { d as R, o as H, b as S, I as L, C as $, f as A, g as G } from './get-chop-logic-theme-C9Q9v90u.js';
import { r as V } from './index-qVDZzPEr.js';
import { C as k, u as z } from './chop-logic-form-context-lL0zfSzs.js';
import { u as B } from './index-B0wHt5J_.js';
function D({ name: e, initialValues: r, defaultValue: a }) {
  return r && r[e] ? Number(r[e]) : a && typeof a == 'number' ? a : 0;
}
function O({ value: e, required: r, validator: a, maxValue: t, minValue: i }) {
  return r && !a && e === void 0 ? !1 : a && typeof a == 'function' ? a(e) : t && i && e && !a ? e <= t && e >= i : !0;
}
function W({ name: e, defaultValue: r, onChange: a, onSpinButtonClick: t, min: i, max: y, step: o, required: I, validator: N }) {
  const { onChangeFormInput: l, initialValues: x } = V.useContext(k),
    c = D({ initialValues: x, defaultValue: r, name: e }),
    m = y ? Number(y) : Number.MAX_SAFE_INTEGER,
    p = i ? Number(i) : Number.MIN_SAFE_INTEGER,
    [s, h] = V.useState(c),
    [q, b] = V.useState(!0),
    f = (u) => {
      h(u);
      const d = O({ value: u, required: I, validator: N, maxValue: m, minValue: p });
      b(d), l == null || l({ name: e, value: u, valid: d });
    },
    _ = (u) => {
    ...
    E = V.useCallback(() => {
      h(c), l == null || l({ name: e, value: c, valid: !0 });
    }, [e]);
  return B(E), { handleChange: _, value: s, valid: q, minValue: p, maxValue: m, increment: g, decrement: v };
}
const C = R.div`
  display: flex;
...
`;
try {
  (C.displayName = 'StyledNumericInput'),
    (C.__docgenInfo = {
      description: '',
      displayName: 'StyledNumericInput',
      props: {
...
const U = ({
  ...
  const { elementId: g, errorId: v } = z(x),
    E = G(f),
    {
      value: u,
      valid: d,
      ...
      minValue: T,
      maxValue: M,
    } = W({ name: e, defaultValue: q, min: N, max: l, onChange: t, required: p, validator: I, step: b, onSpinButtonClick: o });
  return n.jsx(H, {
    theme: E,
    children: n.jsxs(C, {
      ..._,
      children: [
        n.jsx(S, { label: r, required: p, inputId: g }),
        n.jsxs('div', {
          children: [
            n.jsx('input', {
              id: g,
            ...
            h &&
              n.jsxs('span', {
                children: [
                  n.jsx(L, { onClick: F, label: `Decrement value for ${r}`, icon: $.ChevronLeft, disabled: m }),
                  n.jsx(L, { onClick: w, label: `Increment value for ${r}`, icon: $.ChevronRight, disabled: m }),
                ],
              }),
          ],
        }),
        n.jsx(A, { errorId: v, message: a, visible: !d }),
      ],
    }),
  });
};
  ...
  (NumericInput.displayName = 'NumericInput'),
    (NumericInput.__docgenInfo = {
      ...
      props: {
        ...
        validator: { defaultValue: null, description: '', name: 'validator', required: !1, type: { name: 'NumericValidationFunction' } },
        hasSpinButtons: {
        ...
        step: { defaultValue: { value: '1' }, description: '', name: 'step', required: !1, type: { name: 'number' } },
        readOnly: { defaultValue: { value: 'false' }, description: '', name: 'readOnly', required: !1, type: { name: 'boolean' } },
        defaultValue: { defaultValue: { value: '0' }, description: '', name: 'defaultValue', required: !1, type: { name: 'number' } },
        onSpinButtonClick: {
          defaultValue: null,
          description: '',
          name: 'onSpinButtonClick',
          required: !1,
