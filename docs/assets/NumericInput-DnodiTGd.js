...
import { ae as i, af as s } from './index-BZ-G-mNy.js';
import { N as l, D as c } from './NumericInput.stories-DLUD4D-3.js';
...
function t(d) {
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(i, { of: l, title: 'NumericInput' }),
      `
`,
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `import { ChopLogicNumericInput } from 'chop-logic-components';
            ...
            children: [
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: e.jsx(n.code, { children: '(value?: number) => void' }) }),
                  e.jsx(n.td, {
                    children:
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'onSpinButtonClick' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: '(value?: number) => void' }) }),
                  e.jsx(n.td, { children: 'A function that is called when one of the spin buttons is clicked.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'step' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'number' }) }),
                  e.jsx(n.td, { children: 'The number by which the input value is incremented/decremented when pressing keyboard keys.' }),
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'max' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'number' }) }),
                  e.jsx(n.td, { children: 'Maximum number in the input.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'min' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'number' }) }),
                  e.jsx(n.td, { children: 'Minimum number in the input.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'undefined' }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'number' }) }),
                  e.jsx(n.td, { children: 'Initial number in the input.' }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: '0' }) }),
                  e.jsx(n.td, { children: 'No' }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: e.jsx(n.strong, { children: 'hasSpinButtons' }) }),
                  e.jsx(n.td, { children: e.jsx(n.code, { children: 'boolean' }) }),
                  e.jsx(n.td, { children: 'A boolean indicating whether to display the spin buttons.' }),
...
`,
      e.jsx(n.pre, {
        children: e.jsx(n.code, {
          ...
          children: `export type ChopLogicNumericInputProps = CommonInputProps & {
  errorMessage?: string;
