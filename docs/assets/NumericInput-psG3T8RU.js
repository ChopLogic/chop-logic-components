import{j as i}from"./jsx-runtime-CLpGMVip.js";import{b as R,I as C,C as L,c as A}from"./Label-iILYjsvu.js";import{C as F,d as H,c as S,u as k}from"./index-zvdF3J3f.js";import{r as I}from"./index-B_nTefMF.js";import{u as z}from"./index-CKFmP5XW.js";function O({name:e,initialValues:r,defaultValue:a}){return r&&r[e]?Number(r[e]):a&&typeof a=="number"?a:0}function B({value:e,required:r,validator:a,maxValue:t,minValue:u}){return r&&!a&&e===void 0?!1:a&&typeof a=="function"?a(e):t&&u&&e&&!a?e<=t&&e>=u:!0}function D({name:e,defaultValue:r,onChange:a,onSpinButtonClick:t,min:u,max:h,step:o,required:N,validator:x}){const{onChangeFormInput:l,initialValues:$}=I.useContext(F),f=O({initialValues:$,defaultValue:r,name:e}),m=h?Number(h):Number.MAX_SAFE_INTEGER,p=u?Number(u):Number.MIN_SAFE_INTEGER,[s,g]=I.useState(f),[q,y]=I.useState(!0),b=n=>{g(n);const c=B({value:n,required:N,validator:x,maxValue:m,minValue:p});y(c),l==null||l({name:e,value:n,valid:c})},v=n=>{const c=Number(n.target.value);b(c),a==null||a(n)},V=()=>{b(s+o),t==null||t(s+o)},d=()=>{b(s-o),t==null||t(s-o)},_=I.useCallback(()=>{g(f),y(!0),l==null||l({name:e,value:f,valid:!0})},[e]);return z(_),{handleChange:v,value:s,valid:q,minValue:p,maxValue:m,increment:V,decrement:d}}const E=H.div`
  display: flex;
