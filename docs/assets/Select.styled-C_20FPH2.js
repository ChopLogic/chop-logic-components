import { d as r } from './get-chop-logic-theme-C9Q9v90u.js';
function n(e) {
  const t = document.getElementById(e);
  t && t.focus();
}
function y({ e, options: t, onClose: u }) {
  let d = '';
  t.forEach((a) => {
    document.getElementById(a.id) === document.activeElement && (d = a.id);
  });
  const i = t.findIndex((a) => a.id === d);
  switch (e.key) {
    case 'Escape':
      e.preventDefault(), u();
      break;
...
try {
  (c.displayName = 'StyledSelectCombobox'),
    (c.__docgenInfo = {
      description: '',
      displayName: 'StyledSelectCombobox',
      props: {
        theme: { defaultValue: null, description: '', name: 'theme', required: !1, type: { name: 'DefaultTheme' } },
        as: { defaultValue: null, description: '', name: 'as', required: !1, type: { name: 'void | WebTarget' } },
        forwardedAs: { defaultValue: null, description: '', name: 'forwardedAs', required: !1, type: { name: 'void | WebTarget' } },
...
try {
  (p.displayName = 'StyledSelectDropdown'),
    (p.__docgenInfo = {
      description: '',
      displayName: 'StyledSelectDropdown',
      props: {
        theme: { defaultValue: null, description: '', name: 'theme', required: !1, type: { name: 'DefaultTheme' } },
        as: { defaultValue: null, description: '', name: 'as', required: !1, type: { name: 'void | WebTarget' } },
        forwardedAs: { defaultValue: null, description: '', name: 'forwardedAs', required: !1, type: { name: 'void | WebTarget' } },
...
try {
  (l.displayName = 'StyledSelectOption'),
    (l.__docgenInfo = {
      description: '',
      displayName: 'StyledSelectOption',
      props: {
        theme: { defaultValue: null, description: '', name: 'theme', required: !1, type: { name: 'DefaultTheme' } },
        as: { defaultValue: null, description: '', name: 'as', required: !1, type: { name: 'void | WebTarget' } },
        forwardedAs: { defaultValue: null, description: '', name: 'forwardedAs', required: !1, type: { name: 'void | WebTarget' } },
...
try {
  (m.displayName = 'StyledMultiSelectOption'),
    (m.__docgenInfo = {
      description: '',
      displayName: 'StyledMultiSelectOption',
      props: {
        theme: { defaultValue: null, description: '', name: 'theme', required: !1, type: { name: 'DefaultTheme' } },
        as: { defaultValue: null, description: '', name: 'as', required: !1, type: { name: 'void | WebTarget' } },
        forwardedAs: { defaultValue: null, description: '', name: 'forwardedAs', required: !1, type: { name: 'void | WebTarget' } },
...
export { c as S, m as a, p as b, s as c, l as d, y as h, n as m };
