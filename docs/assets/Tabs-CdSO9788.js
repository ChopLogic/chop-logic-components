import{j as a}from"./jsx-runtime-OAISXtky.js";import{a as q,f as w,d as ue,C,b as $e}from"./Label-BFqmiq52.js";import"./Checkbox-7RQ_DSvF.js";import"./MultiSelect-Bq3qlABc.js";import"./NumericInput-CgE6rvX4.js";import"./Select-BCyYHUxS.js";import"./TextInput-bK9NZByA.js";import{d as c,u as x,c as de,C as ve}from"./index-BT98D5zi.js";import{r as y}from"./index-qVDZzPEr.js";import{R as Ve}from"./index-DzcqJxd1.js";import{u as ce}from"./index-Bg4JDWSn.js";import{u as pe}from"./index-BeH7sH-W.js";import{u as qe}from"./index-7QOc-elU.js";import{u as me}from"./index-D9uBcq_H.js";import xe from"./CheckMarkIcon-BtcQ9zhB.js";import Ce from"./ErrorIcon-D8B-aMuv.js";import we from"./HelpIcon-2xCcuWCH.js";import Se from"./InfoIcon-DokxbF3b.js";import Ie from"./WarningIcon-CeD2ynrn.js";import Te from"./CheckboxCheckedIcon-B0tMICzp.js";import ke from"./CheckboxUncheckedIcon-Di1hGFhe.js";import{m as se}from"./Select.styled-BJZBRQF3.js";const Ne=Object.freeze({phones:"only screen and (max-width: 600px)",portraitTablets:"only screen and (min-width: 600px)",landscapeTablets:"only screen and (min-width: 768px)",laptops:"only screen and (min-width: 992px)",desktops:"only screen and (min-width: 1200px)"});var _=(e=>(e.Success="success",e.Error="error",e.Warning="warning",e.Info="info",e.Help="help",e))(_||{}),V=(e=>(e.Primary="primary",e.Flat="flat",e.Icon="icon",e))(V||{}),g=(e=>(e.Vertical="vertical",e.Horizontal="horizontal",e))(g||{}),fe=(e=>(e.Span="span",e.Div="div",e.P="p",e.Strong="strong",e.Em="em",e))(fe||{});function B(e){return({tooltip:t,visibleOn:r,...l})=>t!=null&&t.length?a.jsx(He,{tooltipContent:t,visibleOn:r,children:a.jsx(e,{...l})}):a.jsx(e,{...l})}try{B.displayName="withTooltip",B.__docgenInfo={description:"",displayName:"withTooltip",props:{}}}catch{}const Be=({modalRef:e,isOpened:t})=>{y.useEffect(()=>{const r=e.current;if(!t||!r)return;const l=r.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),n=l[0],o=l[l.length-1],i=s=>{s.key==="Tab"&&(s.shiftKey&&document.activeElement===n?(s.preventDefault(),o.focus()):!s.shiftKey&&document.activeElement===o&&(s.preventDefault(),n.focus()))};return r.addEventListener("keydown",i),()=>{r.removeEventListener("keydown",i)}},[e,t])},A=c.button`
  position: relative;
  border: none;
