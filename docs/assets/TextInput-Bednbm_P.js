import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{b as B,I as S,C as w,e as H}from"./Label-B75NJM6h.js";import{C as N,d as R,c as A,u as P}from"./index-zGLxtP0c.js";import{r as f}from"./index-MPVjHJeJ.js";import{u as F}from"./index-_kABAdFM.js";function W({value:e,required:a,validator:t}){return a&&!t&&!e.length?!1:t&&typeof t=="function"?t(e):t&&typeof t=="object"?new RegExp(t.regexp,t==null?void 0:t.flags).test(e):!0}function z({name:e,initialValues:a,defaultValue:t}){return a&&(a!=null&&a[e])?a[e].toString():t&&typeof t=="string"?t:""}function O({name:e,defaultValue:a,onChange:t,onClear:s,required:x,validator:b}){const{onChangeFormInput:n,initialValues:v}=f.useContext(N),i=z({initialValues:v,defaultValue:a,name:e}),[V,o]=f.useState(i),[$,u]=f.useState(!0),[r,d]=f.useState(!1),q=y=>{const p=y.target.value,c=W({value:p,required:x,validator:b});o(p),u(c),n==null||n({name:e,value:p,valid:c}),t==null||t(y)},g=()=>{o(""),u(!0),n==null||n({name:e,value:"",valid:!0}),s==null||s()},I=f.useCallback(()=>{o(i),u(!0),n==null||n({name:e,value:i,valid:!0})},[e]),h=()=>{d(!r)};return F(I),{value:V,valid:$,passwordShown:r,handleChange:q,handleClear:g,togglePassword:h}}const C=R.div`
  display: flex;
