import{j as l}from"./jsx-runtime-OAISXtky.js";import{u as H,d as B,a as N,b as R,I as S,C as w,f as A}from"./index-Dk2A2uom.js";import{r as f}from"./index-qVDZzPEr.js";import{a as P,u as F}from"./index-tKWUWaCX.js";function W({value:e,required:a,validator:t}){return a&&!t&&!e.length?!1:t&&typeof t=="function"?t(e):t&&typeof t=="object"?new RegExp(t.regexp,t==null?void 0:t.flags).test(e):!0}function z({name:e,initialValues:a,defaultValue:t}){return a&&(a!=null&&a[e])?a[e].toString():t&&typeof t=="string"?t:""}function O({name:e,defaultValue:a,onChange:t,onClear:s,required:x,validator:b}){const{onChangeFormInput:n,initialValues:v}=f.useContext(P),i=z({initialValues:v,defaultValue:a,name:e}),[V,u]=f.useState(i),[$,o]=f.useState(!0),[r,d]=f.useState(!1),q=y=>{const p=y.target.value,c=W({value:p,required:x,validator:b});u(p),o(c),n==null||n({name:e,value:p,valid:c}),t==null||t(y)},g=()=>{u(""),o(!0),n==null||n({name:e,value:"",valid:!0}),s==null||s()},I=f.useCallback(()=>{u(i),o(!0),n==null||n({name:e,value:i,valid:!0})},[e]),h=()=>{d(!r)};return H(I),{value:V,valid:$,passwordShown:r,handleChange:q,handleClear:g,togglePassword:h}}const T=B.div`
  display: flex;
