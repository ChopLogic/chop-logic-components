import{j as e}from"./iframe-CrArNGRw.js";import{useMDXComponents as o}from"./index-BSFtI4hN.js";import{M as r}from"./blocks-Bk_K6NSa.js";import"./index-B4hisE-5.js";import"./index-BU1teVQ0.js";function t(s){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Hooks/useAutoClose"}),`
...
`,e.jsx(n.p,{children:"Encapsulates timer logic for automatically closing UI components, helping to:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Reduce boilerplate code in components"}),`
`,e.jsx(n.li,{children:"Ensure consistent behavior across all auto-closing elements"}),`
`,e.jsx(n.li,{children:"Properly handle cleanup to prevent memory leaks"}),`
`,e.jsx(n.li,{children:"Maintain TypeScript type safety"}),`
`]}),`
...
`,e.jsx(n.p,{children:"This hook does not return any value."}),`
