import{j as e}from"./iframe-CrArNGRw.js";import{useMDXComponents as o}from"./index-BSFtI4hN.js";import{M as s}from"./blocks-Bk_K6NSa.js";import"./index-B4hisE-5.js";import"./index-BU1teVQ0.js";function r(t){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Hooks/useIsOverflow"}),`
`,e.jsx(n.h1,{id:"useisoverflow",children:"useIsOverflow"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"useIsOverflow"})," hook detects when content overflows its container in either width or height dimension."]}),`
`,e.jsx(n.h2,{id:"purpose",children:"Purpose"}),`
`,e.jsx(n.p,{children:"Helps manage overflow scenarios by:"}),`
