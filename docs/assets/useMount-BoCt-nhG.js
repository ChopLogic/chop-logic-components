...
import { ae as i, af as r, ag as a } from './index-BZ-G-mNy.js';
import { U as m, D as p } from './useMount.stories-DsgzmHWa.js';
...
function t(o) {
  const e = { code: 'code', h1: 'h1', h2: 'h2', li: 'li', p: 'p', pre: 'pre', strong: 'strong', ul: 'ul', ...s(), ...o.components };
  return n.jsxs(n.Fragment, {
    children: [
      n.jsx(i, { of: m, title: 'Hooks/useMount' }),
      `
`,
...
`,
      n.jsxs(e.p, {
        children: ['The ', n.jsx(e.code, { children: 'useMount' }), ' hook manages the mounting state of a component with a delay.'],
      }),
      `
`,
...
`,
          n.jsxs(e.li, {
            children: [
              n.jsx(e.strong, { children: 'isOpened' }),
              `
Type: boolean
...
function y(o = {}) {
  const { wrapper: e } = { ...s(), ...o.components };
  return e ? n.jsx(e, { ...o, children: n.jsx(t, { ...o }) }) : t(o);
}
export { y as default };
