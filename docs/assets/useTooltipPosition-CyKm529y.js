...
import { ae as s, af as l, ag as r } from './index-BZ-G-mNy.js';
import { U as p, D as c } from './useTooltipPosition.stories-CqkSYvZt.js';
...
function o(t) {
  const n = { code: 'code', h1: 'h1', h2: 'h2', li: 'li', p: 'p', pre: 'pre', strong: 'strong', ul: 'ul', ...i(), ...t.components };
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(s, { of: p, title: 'Hooks/useTooltipPosition' }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          'The ',
          e.jsx(n.code, { children: 'useTooltipPosition' }),
          ' hook calculates and manages the position of a tooltip relative to a reference element.',
        ],
      }),
      `
`,
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.strong, { children: 'wrapperRef' }),
              `
`,
              e.jsxs(n.ul, {
                children: [
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.strong, { children: 'tooltipRef' }),
              `
`,
              e.jsxs(n.ul, {
                children: [
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.strong, { children: 'isOpened' }),
              `
`,
              e.jsxs(n.ul, {
                children: [
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.strong, { children: 'spacing' }),
              `
`,
              e.jsxs(n.ul, {
                children: [
