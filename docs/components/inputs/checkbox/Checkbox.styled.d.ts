...
export declare const StyledCheckboxWrapper: import('styled-components/dist/types').IStyledComponentBase<
  'web',
...
> &
  string;
export declare const StyledCheckboxInput: import('styled-components/dist/types').IStyledComponentBase<
  'web',
