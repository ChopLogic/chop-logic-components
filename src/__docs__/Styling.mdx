...
- **Component Scoped Styles**: Each component has its own CSS file with **BEM naming** (`.cl-*` prefix)
...
See the [Colors](/?path=/docs/theming-colors--docs) page for the complete color palette.
...
See the [Provider](/?path=/docs/theming-provider--docs) page for more details.
