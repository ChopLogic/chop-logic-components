...
export const TooltipExample: FC<TooltipProps> = ({ tooltipContent, containerTag, visibleOn, id, ...rest }) => {
  return (
    <div>
      <Tooltip tooltipContent={tooltipContent} containerTag={containerTag} visibleOn={visibleOn} id={id} {...rest}>
