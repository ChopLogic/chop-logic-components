...
| **validator**    | `ChopLogicRegExpWithFlags` or `ChopLogicTextInputValidator` | A function or regular expression that allows you to validate an input value and display an error message if validation fails.            | `undefined`      | No       |
